...
var GameTimerManager = {
    ...
    _updateTimer: function() {
        ...
        if(this._elapsedTime >= this._limitTime && !this._timeover){
            this._timeover = true;
            this._callback(this._elapsedTime);
        }
    },
...
//        this._backgroundNode.drawSolidRect(cc.p(0, 0), cc.p(width, height), pastelColor);
        ...
        parent.schedule(this._boundUpdateTimer, 1.0, cc.REPEAT_FOREVER, 0);
    },
...
var LyricsLayer = cc.Layer.extend({
    ...
    init:function(){
        ...
        self.txt_board = C_AddSprite(startlayer,res.n_lyrics_txt_board, size.width/2, C_getY(800),null,null,null); // 할아버지 
