...
<!--    당겨서 새로고침
    ...
    -->
    <script src="js/scripts.js?ver3.02aab10"></script>
...
//        var container = document.getElementById("container");
       ...
       if(auth < AUTH_TRANER){
        ...
        function GX_init(callback){
            ...
            if(centercodes)param_centercode = centercodes[0];
                        ...
                        <tr >
                            <td colspan="7" style="text-align: center;">
                              ...
                              <!--  <span class="btn-group" style="border-radius:20px;margin-left:5px;margin-right:2px;">
                                ...
                                <!-- GX룸 개수 -->
                                 {{   if (mode ==='month') {  }}
                                <button id="total_gxroom_count" style="float:left;margin-left:10px;background-color:#333333;height:32px;color:white;font-size:12px;border-radius:16px;padding-left:15px;padding-right:15px;display:none">GX룸: 0개</button>
                                {{ }  }}
                                <!-- 오늘로가기 -->
...
//                var isremainprice = user.remainprice && user.remainprice.remain && parseInt(user.remainprice.remain) > 0 ? true : false;
                ...
                if(isremainprice) console.log("user.remainprice.remain", user.remainprice.remain);
                if(eday < 0){
                    rectimgname = isremainprice ? "./img/icrect_ptoff_remainprice.png" : "./img/icrect_ptoff.png";
                }
                else {
...
//        clog("thisWeek ",thisWeek);
    ...
    function reload_calendar_page(centercode){
        ...
        refresh_page("?centercode="+param_centercode+"&day="+param_day+"&useruid="+select_useruid); 
    }
</script>
