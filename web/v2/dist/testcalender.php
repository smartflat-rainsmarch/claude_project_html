          ...
          <table style="white-space: nowrap; width: 100%">
            <tr>
              ...
              <td style="text-align: right">
                <span class="btn-group">
                  <button class="js-cal-option btn btn-default {{: mode==='year'? 'active':'' }}" data-mode="year">년</button>
                  <button class="js-cal-option btn btn-default {{: mode==='month'? 'active':'' }}" data-mode="month">월</button>
                  <button class="js-cal-option btn btn-default {{: mode==='week'? 'active':'' }}" data-mode="week">주</button>
...
var data = [],
  ...
  for(i = 0; i < 9; i++) {
    ...
    clog(i+") j:"+j+" c :"+c+" c1:"+c1+" d:"+d+" h:"+h+" m:"+m+" start:"+start+" end:"+end)  
    clog("!(i % 6) "+(!(i % 6)));
...
//      data.push({ title: "test", start: start, end: end, allDay: !(i % 6), text: slipsum[c % slipsum.length ]  });
  }
