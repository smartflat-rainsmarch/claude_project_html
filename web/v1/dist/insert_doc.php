...
-->
                ...
                <div align="center"><button id="btn_insertall" onclick="insertAllUsers()" class="btn btn-primary btn-raised" style="display:none;">모든 데이타 유저로 등록하기</button></div>
