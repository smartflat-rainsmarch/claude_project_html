...
<link href='http://fonts.googleapis.com/css?family=Montserrat+Alternates' rel='stylesheet' type='text/css'> <!--Montserrat 폰트설정-->
<style>
   body {
                ...
                {{
                        if (mode === 'month') { 
                         var m_month = months[month];
                            ...
                            <text style="margin-left:10px;color:white;font-size:17px;"><b>{{: month }}</b>월</text>
                {{ 
                        } 
                        if (mode ==='week') { 
...
//                  clog("홀딩가능하다.!!");
                  ...
                  if(!holding_starttime){
                      ...
                      if(holding_starttime > clicktimestamp){
                          ...
                          holding_endtime = clicktimestamp;
...
//        txt_desc.style.fontWeight = "bold";
    ...
    //               $("#end_modal").modal({ keyboard: false, backdrop: 'static' });
               ...
               showModalDialog(document.body,"시작날짜 변경 완료", "시작날짜를 변경 완료하였습니다." , "확인", null,function(){
                    ...
                    //refresh_page(params);
                   location.href = "m_my_membership_starttime";
                },function(){});
...
//                   location.href = location.href;
                   location.href = "m_my_membership_holding";
               },function(){
                    hideModalDialog();
               });
...
.div1 {position:relative; top:0; width:100%; background-color:green;height:200px;overflow:auto;}

.div2 {position:relative; top:0; width:100%; background-color:red;height:200px;overflow:auto;}
    ...
    function divMouseMove(e) {
        if (eControl) {
            ...
            if (diffpos > -200 && diffpos < 200) {
                document.getElementById("top").style.height = 200 - diffpos + "px";
                document.getElementById("bottom").style.height = 200 + diffpos + "px";
            }
        }
    }

    function init() {
        document.getElementById("middle").onmousedown = divMouseDown;
...
<div class="div1" id="top">TOP DIV</div>

<hr class="hr" id="middle" />

<div class="div2" id="bottom">BOTTOM DIV</div>
