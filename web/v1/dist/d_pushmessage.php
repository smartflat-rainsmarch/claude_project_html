...
//        $(document).ready(function() {
        ...
        $("#pushmessage_form").submit(function(event) {
            ...
            modal_message += "<br><label class='text_style'>*제목</label><p align='center'>" + title + "</p>";
            ...
            if (document.getElementById('push_type').value == 1) {
                ...
                modal_message += "<br><label class='text_style'>*보낼그룹</label><p align='center'>" + topic + "</p>";
            ...
            var date_body = "<label>●시작일 :</label>&nbsp;&nbsp;&nbsp;"+ 
             ...
             console.log("cc");                           
            showModalDialog(document.body,"메세지 기간을 선택해 주세요.", date_body , "확인", null,function(){
                ...
                if(isToday(push_endtime) == 1)
                    ...
                    send_msg(modal_message);
                }
            });

        });
        function send_msg(modal_message){
            clog("send_msg");
