                        ...
                        <table style='width:100%'>
                            <tr>
                                <td  style='width:50%;height:40px'>
                                    <label for="name" class="textevent">새로운 비밀번호<span style='color:red'>*</span></label>
                                </td>
                            </tr>
                            <tr>
                                <td  style='width:50%'>
                                   <input type="text" class="form-control myinputtype" id="pass1" name="company_name" placeholder="비밀번호 입력.." >
                                </td>
                             </tr>
                            <tr>
                                <td  style='width:50%;height:40px'>
                                    <label for="name" class="textevent">비밀번호 확인<span style='color:red'>*</span></label>
                                </td>
                            </tr>
                            <tr>
                                <td  style='width:50%'>
                                   <input type="text" class="form-control myinputtype" id="pass2" name="company_name" placeholder="비밀번호 확인.." >
                                </td>
                             </tr>
...
<!--            </form>-->
            ...
            <br>
            <div style='width:100%'>
                <button id='id_register_join' onclick="btn_register_send()" class="btn btn-primary btn-raised" style='float:right;width:140px;border:0px;'>비밀번호 변경하기</button>
...
//        clog("signtd1 width "+signtd1.offsetWidth+" signtd2 width "+signtd2.offsetWidth);
         ...
         function btn_register_send() {
            ...
            if(pass1 == ""){
                ...
                alertMsg("비밀번호는 영문 숫자를 포함하여 8자리 이상 입력해 주세요.");
                return;
            }
            ...
            changePasswordCheck( _data,function(res){
