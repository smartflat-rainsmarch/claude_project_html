...
(function(root, factory) {
  ...
  TableExport.prototype = {
    ...
    formatConfig: {
      ...
      xlsx: {
        defaultClass: "xlsx",
        buttonContent: "검색결과 엑셀로 다운로드(xlsx)",
        mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        fileExtension: ".xlsx"
      },
      xlsm: {
        defaultClass: "xlsm",
        buttonContent: "검색결과 엑셀로 다운로드(xlsm)",
        mimeType: "application/vnd.ms-excel.sheet.macroEnabled.main+xml",
        fileExtension: ".xlsm"
      },
      xlsb: {
        defaultClass: "검색결과 엑셀로 다운로드(xlsb)",
      ...
      xls: {
        defaultClass: "xls",
        buttonContent: "검색결과 엑셀로 다운로드(xls)",
        separator: "\t",
...
//        exportButton.innerHTML = "<img src ='./img/icon_excel.png' alt=''/>";
      return exportButton;
    },
    /**
...
//          var excelBlob = new Blob([data], { type: mime + ";" + this.charset }, "excel.xlsx");     
//          excelBlob.name = "test.xlsx";
