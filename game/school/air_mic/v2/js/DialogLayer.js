...
//        C_DrawBackColor(self);
    ...
    init:function(title,message, imgres, OKCallback , CancelCallback,style){
        ...
        self._bg.width = 1000;
        self._bg.height = message ? 1300 : 1200;
...
//            C_AddCustomFontNew(self._bg, title, self._bg.width/2,self._bg.height-60,1,1,cc.TEXT_ALIGNMENT_CENTER,40,cc.color(255,255,255),true);
//            // 이제 cocos sprite로 사용
//            var sp = C_AddSpriteImageResize(self._bg, imgres, self._bg.width/2, self._bg.height-430, null,1,null,840); //img
//            C_AddCustomFontNew(self._bg, message, 50, self._bg.height-960 ,1,1,cc.TEXT_ALIGNMENT_LEFT,30,cc.color(255,255,255),true);
//        };
...
//            self._bg.height = 600;
//            C_AddCustomFontNew(self._bg, title, self._bg.width/2,self._bg.height-60,1,1,cc.TEXT_ALIGNMENT_CENTER,40,cc.color(255,255,255),true);
//            C_AddCustomFontNew(self._bg, message, 50, self._bg.height/2,1,1,cc.TEXT_ALIGNMENT_LEFT,30,cc.color(255,255,255),true);    
//        };
//        img.src = imgres;
         C_AddCustomFontNew(self._bg, title, self._bg.width/2,self._bg.height-60,1,1,cc.TEXT_ALIGNMENT_CENTER,40,cc.color(31,31,31),true);
        console.log("imgres is "+imgres);
        C_AddSpriteImageResize(self._bg, imgres, self._bg.width/2, self._bg.height/2, null,1,null,840); //img
