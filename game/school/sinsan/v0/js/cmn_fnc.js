...
//     }
     ...
     var date = new Date();
    var h = date.getHours();
    if(obj_weather)if(before_weatherhour == -1 || before_weatherhour != h)C_updateWeather(obj_weather.sp, obj_weather.data);
    if(obj_weather)if(before_airhour == -1 || before_airhour != h)C_updateAir(obj_air.sp, obj_air.data);
