...
//        C_DrawBackColor(self);
    ...
    init:function(title,message, OKCallback , CancelCallback,style, closetime){
        var self = this;
        var size = cc.winSize;
...
//        self._bg.addChild(title);
        ...
        //message Texxt
        C_AddCustomFont(self._bg, message, self._bg.width/2, self._bg.height/2,1,1,cc.TEXT_ALIGNMENT_CENTER,30,cc.color(255,255,255));
