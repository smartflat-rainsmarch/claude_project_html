...
//        });
    ...
    drawFloorButtons(){
        ...
        var len = json_floor.floordata.length;
       if(len == 4){
             var textdata0 = {"x":220,"y":255, "message":json_floor.floordata[0].fname,"fontsize":50,"fontweight":"bold","color":"#ffffff","textalign":"center","maxlen":7};
             var textdata1 = {"x":220,"y":255, "message":json_floor.floordata[1].fname,"fontsize":50,"fontweight":"bold","color":"#ffffff","textalign":"center","maxlen":7};
             var textdata2 = {"x":220,"y":255, "message":json_floor.floordata[2].fname,"fontsize":50,"fontweight":"bold","color":"#ffffff","textalign":"center","maxlen":7};
             var textdata3 = {"x":220,"y":255, "message":json_floor.floordata[3].fname,"fontsize":50,"fontweight":"bold","color":"#ffffff","textalign":"center","maxlen":6};
            
            
             
             sp = textdata0.message ? C_AddSpriteTouch(self,res._global_floor_bg0, 295, C_getY(700), "floor_0", scale, null, function(tag) {
                self.buttonClick(tag);
             },textdata0) : C_AddSprite(self,res._global_floor_bg_off, 295, C_getY(700),null,null); 
             sp = textdata1.message ? C_AddSpriteTouch(self,res._global_floor_bg1, 775, C_getY(700), "floor_1", scale, null, function(tag) {
                self.buttonClick(tag);
             },textdata1) : C_AddSprite(self,res._global_floor_bg_off, 775, C_getY(700),null,null); 
             sp = textdata2.message ? C_AddSpriteTouch(self,res._global_floor_bg2, 295, C_getY(1300), "floor_2", scale, null, function(tag) {
                self.buttonClick(tag);
             },textdata2): C_AddSprite(self,res._global_floor_bg_off, 295, C_getY(1300),null,null); 
             sp = textdata3.message ? C_AddSpriteTouch(self,res._global_floor_bg3, 775, C_getY(1300), "floor_3", scale, null, function(tag) {
                self.buttonClick(tag);
            ...
            for(var i = 0 ;i  < len; i++){
                 var floordata = json_floor.floordata[i];
                 var _y = offsetY-gabY*i;
                console.log("_y ",_y);
                 var textdata = {"x":150,"y":85, "message":floordata.fname,"fontsize":50,"fontweight":"bold","color":"#ffffff","textalign":"center","maxlen":6};
                 sp = C_AddSpriteTouch(self,"res/global/floor_bg"+(i%4+10)+".png", 540, _y, "floor_"+i, scale, null, function(tag) {
                    self.buttonClick(tag);
                 },textdata); 
            }
        }
