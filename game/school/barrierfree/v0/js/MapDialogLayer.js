...
//        this.addChild (self._bg);
        ...
        //층별안내 버튼        
        var f1 = C_AddAnimButton(self._bg, "res/btn_0f.png" ,null, 80,C_getY(1780),tag_dialog.f1,0.7,null,function(tag){
            if(self.floor != 1){
                self.floor = 1; 
                self.buttonClick(tag);
            }
        },self);
        var f2 = C_AddAnimButton(self._bg, "res/btn_1f.png" ,null, 160,C_getY(1780),tag_dialog.f2,0.7,null,function(tag){
            if(self.floor != 2){
                self.floor = 2; 
                self.buttonClick(tag);
            }
        },self);
         var f3 = C_AddAnimButton(self._bg, "res/btn_2f.png" ,null, 240,C_getY(1780),tag_dialog.f3,0.7,null,function(tag){
            if(self.floor != 3){
                self.floor = 3; 
                self.buttonClick(tag);
            }
        },self);
        var f4 = C_AddAnimButton(self._bg, "res/btn_3f.png" ,null, 320,C_getY(1780),tag_dialog.f4,0.7,null,function(tag){
            if(self.floor != 4){
                self.floor = 4; 
                self.buttonClick(tag);
            }
        },self);
         var f5 = C_AddAnimButton(self._bg, "res/btn_4f.png" ,null, 400,C_getY(1780),tag_dialog.f5,0.7,null,function(tag){
            if(self.floor != 5){
                self.floor = 5; 
                self.buttonClick(tag);
            }
...
//        var floor_btn2 = C_AddSprite(self._bg,  "res/btn_2f_on.png", 400,C_getY(1780),1,null,null);
        var floor_btn1 = C_AddSprite(f1,  "res/btn_0f_on.png", 0,0,1,null,null);
        var floor_btn2 = C_AddSprite(f2,  "res/btn_1f_on.png", 0,0,1,null,null);
        var floor_btn3 = C_AddSprite(f3,  "res/btn_2f_on.png", 0,0,1,null,null);
        var floor_btn4 = C_AddSprite(f4,  "res/btn_3f_on.png", 0,0,1,null,null);
        var floor_btn5 = C_AddSprite(f5,  "res/btn_4f_on.png", 0,0,1,null,null);
...
//        self._bg.addChild(message);
    ...
    clickFloor:function(){
        ...
        if(idx >= 0){
            ...
            var scale = cc.scaleTo(0.3,1.2,1.2);
