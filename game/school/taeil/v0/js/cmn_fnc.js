...
function C_AddAnimButton(parent,normal_url,click_url,x,y,tag,scale,zindex,callback,userdata,width,height){
    ...
    if (width && height) {
        let originalSize = 60;
//        nButton.setContentSize(width, height);
        nButton.setScaleX(width / originalSize);
        nButton.setScaleY(height / originalSize);
    }
...
//     C_AddCustomFont(parent,weatherdata.today_tmp+"℃", x, y+20, null, 1, cc.TEXT_ALIGNMENT_CENTER , 60, C_HEXtoCCColor(spdata.fontcolor),false);    
     C_AddSprite(parent,getWeatherIconRes(weatherdata.today_sky, weatherdata.today_pty), x, y+50,1,spdata.iconscale,null);    
     C_AddCustomFont(parent,"최저"+weatherdata.today_tmn+" • 최고"+weatherdata.today_tmx, x, y-10, null, 1, cc.TEXT_ALIGNMENT_CENTER , 18, C_HEXtoCCColor(spdata.fontcolor),false);    
//     C_AddCustomFont(parent,"최고"+weatherdata.today_tmx+"℃", x, y, null, 1, cc.TEXT_ALIGNMENT_CENTER , 18, C_HEXtoCCColor(spdata.fontcolor),false);    
