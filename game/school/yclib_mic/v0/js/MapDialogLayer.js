...
//        this.addChild (self._bg);
        ...
        //층별안내 버튼        
        C_AddAnimButton(self._bg, "res/btn_1f.png" ,null, 60,C_getY(370),tag_dialog.f1,0.7,null,function(tag){self.buttonClick(tag);},self);
        C_AddAnimButton(self._bg, "res/btn_2f.png" ,null, 60+80,C_getY(370),tag_dialog.f2,0.7,null,function(tag){self.buttonClick(tag);},self);
        C_AddAnimButton(self._bg, "res/btn_3f.png" ,null, 60+80*2,C_getY(370),tag_dialog.f3,0.7,null,function(tag){self.buttonClick(tag);},self);
        C_AddAnimButton(self._bg, "res/btn_4f.png" ,null, 60+80*3,C_getY(370),tag_dialog.f4,0.7,null,function(tag){self.buttonClick(tag);},self);
        C_AddAnimButton(self._bg, "res/btn_5f.png" ,null, 60+80*4,C_getY(370),tag_dialog.f5,0.7,null,function(tag){self.buttonClick(tag);},self);
...
//        C_SaveData("health_speed",speed);
   ...
   initMap: function (_bg, value) {
        ...
        if (!this.clipper) {
            ...
            this.clipper.setPosition((_bg.width - _w) / 2, 50);
