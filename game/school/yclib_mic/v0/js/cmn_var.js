...
var SOUND = {
    SIGN:"01",
    HELLO:"hello",
    MOVE_HOME:"move_home", //홈화면이동
    MOVE_FACILITY:"move_facility", // 시설안내 이동
    MOVE_OPERATIONHOURS:"move_operatinghours", //운영시간 이동
    MOVE_USING:"move_using", // 이용안내 이동 
    MOVE_FESTIVAL:"move_festival",//행사안내 이동
    CASH:"08",
    COUNTDOWN:"09",
    CLOCK:"13",
    BGM:"game_bgm",
...
var ADM_TYPE = {
    ...
    CHECK_AUTO_UPDATE : "checkautoupdate"
}