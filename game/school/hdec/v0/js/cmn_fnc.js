...
function drawAirText(parent, x, y, mode, dustInfo){
   ...
   if(!parent)return;
    ...
    if(mode == "icon"){
        ...
        C_AddCustomFont(parent,"미세먼지", x, y+30, null, 1, cc.TEXT_ALIGNMENT_CENTER , 20, C_HEXtoCCColor("#ffffff"),false);    
        if(_icon)C_AddSprite(parent,_icon, x, y-30,1,1,null);    
    }else { // text mode
        var _grade = dustInfo.grade ? dustInfo.grade : "";
        C_AddCustomFont(parent,"미세먼지 "+_grade, x, y+30, null, 1, cc.TEXT_ALIGNMENT_CENTER , 20, C_HEXtoCCColor("#ffffff"),false);    
...
function drawWeatherToday(parent, x, y, weatherdata, spdata){//mode, _fontColor, _fontSizeBig, _fontSizeSmall,iconscale){
     ...
     C_AddSprite(parent,getWeatherIconRes(weatherdata.today_sky, weatherdata.today_pty), x+200, y+30,1,spdata.iconscale,null);    
     ...
     C_AddCustomFont(parent,"최고기온"+weatherdata.today_tmx+"℃", x+200, y-30, null, 1, cc.TEXT_ALIGNMENT_CENTER , 20, C_HEXtoCCColor(spdata.fontcolor),false);    
