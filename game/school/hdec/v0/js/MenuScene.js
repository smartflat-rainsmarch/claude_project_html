...
//        for(var i = 0 ; i < 3;i++){//test
        ...
        C_AddCustomFont(self, data.name, 320, C_getY(175), null, 1, cc.TEXT_ALIGNMENT_CENTER , 40, C_HEXtoCCColor("#ffffff"),false);    
...
//        console.log("screen_height "+screen_height+" canvas_height "+(canvas_height*finalScale));
        ...
        this.addWebView(this.sp_rect, 540+mx, 840+my, 1080, 1680, this.pageurl);
    },
