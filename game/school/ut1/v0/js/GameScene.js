...
//                self.sp_title = null;
//            }
//            self.sp_title = C_AddCustomFont(self, data.name, 235, C_getY(115), null, 1, cc.TEXT_ALIGNMENT_LEFT , 60, C_HEXtoCCColor("#005285"),true);    
//        }
//        
...
//        var schoolapitype = self.now_contentdata.schoolapitype ? self.now_contentdata.schoolapitype : "";
                 ...
                 this.pageurl = "https://makesflat.co.kr";
                setTimeout(function(){
                 self.showWebView();   
                },100);
...
//        self.updateBGUI(_tab);
         ...
         C_AddAnimButton(self,res.btn_ok,null,size.width/2,C_getY(70),1,0.7,9999,function(tag){
                console.log("OK버튼클릭");
...
var GameScene = cc.Scene.extend({
    ...
    onEnter: function () {
        this._super();
        var layer = new GameLayer(this._data); // Layer에 data 전달
        this.addChild(layer);
    }
});
