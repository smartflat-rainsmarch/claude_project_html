        ...
        if(self.isPosterScene){
             const listener = cc.EventListener.create({
                ...
                onTouchEnded: function (touch) {
                    ...
                    //터치시 홈화면으로 이동  START
                    ////////////////////////////////////////
                    if (self.now_tab == 2 && parseInt(self.now_contentdata.isfirstscene) == 1) {
...
//        console.log("addWebView");
    ...
    addWebView: function(parent, x, y, w, h, pageurl) {
        ...
        this.webview.loadURL(pageurl+"?projectid="+param_projectid+"&groupidx="+param_groupidx+"&listid="+self.now_contentdata.id+_param_schoolapitype+_param_gamemode+_param_surveyidx+_param_surveyonoff+_param_cb);
...
//        console.log("screen_height "+screen_height+" canvas_height "+(canvas_height*finalScale));
        ...
        this.addWebView(this.sp_rect, 540+mx, 986+my, 1080, 1570, this.pageurl);
    },
