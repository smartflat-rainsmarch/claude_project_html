...
//        self.setSubButtons(this._data);
    ...
    init:function(data){
        ...
        self.sp_title = C_AddCustomFont(self, data.name, 35, C_getY(165), null, 1, cc.TEXT_ALIGNMENT_LEFT , 40, C_HEXtoCCColor("#005285"),true);    
...
//        this.addWebView(this.sp_rect, 1200+mx, 550+my, 1400, 787,  this.pageurl);//16:9  // 일반 비율
        this.addWebView(this.sp_rect, 1200+mx, 500+my, 1200, 900,  this.pageurl);//4:3 power point 비율
    },
